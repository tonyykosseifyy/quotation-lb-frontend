              ...
              <div className={styles.dropdownContainer}>
                  <Dropdown placement="bottom-right">
                      ...
                      <Dropdown.Menu 
                          ...
                          items={moreOptions}
                          onAction={(actionKey) => handleAction(actionKey, row.id)}
                      ...
                      >
                          <Dropdown.Item key="phone_number" className={styles.dropDownItem}> 
                              <CheckBox  
                                  ...
                                  onChange={(event) => { handleCheckboxChange(event); handleShowHideCol('Phone Number')}} /> 
                          </Dropdown.Item>
                          <Dropdown.Item key="balance_USD" className={styles.dropDownItem}>
                              <CheckBox
                                  ...
                                  value="balanceUSD"
                                  isChecked={checkboxValues.value}
                                  onChange={(event) => { handleCheckboxChange(event); handleShowHideCol('Balance USD'); }}
                              />
                          </Dropdown.Item>
                          <Dropdown.Item key="balance_LBP" className={styles.dropDownItem}>
                              <CheckBox
                                  ...
                                  value="balanceLBP"
                                  isChecked={checkboxValues.value}
                                  onChange={(event) => { handleCheckboxChange(event); handleShowHideCol('Balance LBP'); }}
                              />
                          </Dropdown.Item>
                      </Dropdown.Menu>
                  </Dropdown>
