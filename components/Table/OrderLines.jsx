...
<div style={{ display: "flex",justifyContent: "space-between", alignItems: "center",}}>
        ...
        <InputContainer
                        ...
                        <span style={{paddingLeft: "2px",fontStyle: "normal", color: "#868686"}}>Combo</span>
                        </div>
                        }
                        inputType="select"
                        inputName="combo"
...
{ type === 5 &&  
    <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap:"wrap", width: "100%",paddingBottom: "44px"}}>
      <div style={{display: "flex", alignItems: "center"}}>
        ...
        <div style={{paddingLeft: "14px"}}>
             <div style={{ width: "1043px", border: "2px" ,borderRadius: "8px", borderStyle: "dashed", borderColor: "#C4C4C4", display: "flex", padding: "27px 0px 31px 13px"}}>
                          ...
                          <div style={{paddingLeft: "12px", display: "flex", color: "#868686", fontWeight: "500"}}>
      ...
      {/* //Table Footer*/}
      {/* <div style={{paddingLeft: "33px", marginTop: "51px", display: "flex"}}>
        {names.map(({ id, name}) => {
          return (
